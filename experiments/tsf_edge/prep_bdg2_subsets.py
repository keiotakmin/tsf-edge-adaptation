"""M5 (referee): build ADDITIONAL BDG2 subsets to test (a) external validity beyond site Rat
and (b) whether the paper's "BDG2 is flat / adaptation barely pays" byproduct is an artifact
